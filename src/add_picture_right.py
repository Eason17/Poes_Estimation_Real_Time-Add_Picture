...
frame = cv2.imread('face_right1.jpg')
...
for k, d in enumerate(dets):
    ...
    mini_frame = frame[int(p4_y) - 5:int(p4_y) - 5 + shrink_logo.shape[0],
    ...
    mini_dil[:, :, 0] = dil[int(p4_y) - 5:int(p4_y) - 5 + shrink_logo.shape[0],
                        int(p1_x) - 180:int(p1_x) - 180 + shrink_logo.shape[1]]
    mini_dil[:, :, 1] = dil[int(p4_y) - 5:int(p4_y) - 5 + shrink_logo.shape[0],
                        int(p1_x) - 180:int(p1_x) - 180 + shrink_logo.shape[1]]
    mini_dil[:, :, 2] = dil[int(p4_y) - 5:int(p4_y) - 5 + shrink_logo.shape[0],
                        int(p1_x) - 180:int(p1_x) - 180 + shrink_logo.shape[1]]
    ...
    frame[int(p4_y) - 5:int(p4_y) - 5 + shrink_logo.shape[0],
